...
execute as @e[tag=ring_ccw_traveller] at @s facing entity @e[type=marker,limit=1,tag=ring_ccw_centre] feet run function monroe:classes/ring_ccw/travel/coords_xyz/check_location