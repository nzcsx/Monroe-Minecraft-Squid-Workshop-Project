...
# move poses
execute at @s facing entity @e[type=marker,limit=1,tag=ring_ccw_centre_2] feet positioned ^ ^-1.5 ^-0.05 run function monroe:classes/ring_ccw/travel/coords_rot/check_location
