tp @e[type=marker,limit=1,tag=ring_ccw_holder] ~ ~ ~
execute store result score x_holder monroe run data get entity @e[type=marker,tag=ring_ccw_holder,limit=1] Pos[0] 10000
execute store result score y_holder monroe run data get entity @e[type=marker,tag=ring_ccw_holder,limit=1] Pos[1] 10000
