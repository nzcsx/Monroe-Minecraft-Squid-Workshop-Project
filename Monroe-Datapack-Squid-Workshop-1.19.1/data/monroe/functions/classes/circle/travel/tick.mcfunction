...
execute as @e[tag=circle_traveller] at @s positioned ~ ~0.5 ~0.4375 facing entity @e[type=marker,tag=circle_centre,limit=1] feet run function monroe:classes/circle/travel/location_any
